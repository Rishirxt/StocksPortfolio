...
function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      {/* Header */}
      <div className="bg-slate-900/60 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-white">Portfolio Management</h1>
              <p className="text-slate-400">Manage your investment portfolios and track performance</p>
            </div>
            <button 
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              {portfolios.length > 0 ? (
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-slate-500">Investment Portfolio</p>
                        </div>
                        <svg className={`w-5 h-5 transition-colors ${
                          selectedPortfolio?.id === id ? "text-indigo-400" : "text-slate-600"
                      ...
                      <button
                        ...
                        className="mt-3 w-full px-3 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-colors opacity-0 group-hover:opacity-100 flex items-center justify-center border border-red-500/20"
                      >
                ...
                <div className="text-center py-8">
                  <div className="p-3 bg-white/5 border border-white/10 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="lg:col-span-3">
            {selectedPortfolio ? (
              <div className="space-y-6">
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h2 className="text-3xl font-bold text-white">{selectedPortfolio.name}</h2>
                      <p className="text-slate-400">Portfolio Overview & Holdings</p>
                    </div>
                    <button 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-indigo-500/10 border border-indigo-500/20 p-4 rounded-xl">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-indigo-400">Total Holdings</p>
                          <p className="text-2xl font-bold text-white">{portfolioStocks.length}</p>
                        </div>
                    ...
                    <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-emerald-400">Invested Value</p>
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/20 p-4 rounded-xl">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-purple-400">Market Value</p>
                          <p className="text-2xl font-bold text-white">
                  ...
                  <div className="overflow-x-auto">
                    {portfolioStocks.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">No stocks in this portfolio</h3>
                        <p className="text-slate-400 mb-6">Start building your portfolio by adding your first stock.</p>
                        <button 
                          onClick={() => setShowAddStockModal(true)}
                          className="bg-indigo-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-indigo-500 transition-colors shadow-[0_0_20px_rgba(79,70,229,0.3)]"
                        >
                      ...
                      <table className="w-full">
                        <thead className="bg-white/5">
                          <tr>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Symbol</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Purchase Date</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Quantity</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Purchase Price</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Invested Value</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Current Price</th>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-slate-400">Market Value</th>
                          </tr>
                        </thead>
                            ...
                            <tr key={stock.id} className="hover:bg-white/5 transition-colors">
                              <td className="px-6 py-4">
                                <div className="flex items-center">
                                  ...
                                  <span className="font-semibold text-white">{stock.stock_symbol}</span>
                                </div>
                              </td>
                              <td className="px-6 py-4 text-slate-300">{stock.purchase_date}</td>
                              <td className="px-6 py-4 text-slate-300">{stock.quantity}</td>
                              <td className="px-6 py-4 text-slate-300">₹{stock.price.toFixed(2)}</td>
                              <td className="px-6 py-4 text-slate-300">₹{(stock.price * stock.quantity).toFixed(2)}</td>
                              <td className="px-6 py-4 text-slate-300">₹{(stock.current_price || stock.price).toFixed(2)}</td>
                              <td className="px-6 py-4 text-slate-300">₹{(stock.market_value || stock.price * stock.quantity).toFixed(2)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
              ...
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-white/10 p-12 text-center">
                <div className="p-4 bg-white/5 border border-white/10 rounded-full w-24 h-24 mx-auto mb-8 flex items-center justify-center">
                  <svg className="w-12 h-12 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <h2 className="text-3xl font-bold text-white mb-4">Select a Portfolio</h2>
                <p className="text-lg text-slate-400 mb-8 max-w-md mx-auto">
                  Choose a portfolio from the sidebar to view its details, or create a new one to get started.
                </p>
                <button 
                  onClick={() => setShowModal(true)}
                  className="bg-indigo-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-indigo-500 transition-colors shadow-[0_0_20px_rgba(79,70,229,0.3)]"
                >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-slate-900/90 backdrop-blur-2xl border border-white/10 p-8 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] w-96 max-w-md mx-4">
            <div className="flex items-center mb-6">
              <div className="p-2 bg-indigo-500/20 border border-indigo-500/20 rounded-lg mr-3">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-slate-400 mb-2">Portfolio Name</label>
                <input
                  type="text"
                  placeholder="Enter portfolio name"
                  value={newPortfolioName}
                  onChange={(e) => setNewPortfolioName(e.target.value)}
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-white placeholder-slate-500"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-3 mt-8">
              <button
                className="px-6 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-semibold transition-colors"
                onClick={() => setShowModal(false)}
              >
                Cancel
              </button>
              <button
                className="px-6 py-3 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-500 transition-colors shadow-[0_0_15px_rgba(79,70,229,0.3)]"
      ...
      {showAddStockModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-slate-900/90 backdrop-blur-2xl border border-white/10 p-8 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] w-[40rem] max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <div className="p-2 bg-emerald-500/20 border border-emerald-500/20 rounded-lg mr-3">
                  <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                </div>
                <h2 className="text-2xl font-bold text-white">Add Stock to Portfolio</h2>
              </div>
              <button 
                onClick={() => {
                  setShowAddStockModal(false);
            ...
            <div className="mb-6 relative">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Search Stock <span className="text-red-400">*</span>
              </label>
              ...
              {showStockDropdown && !stockToAdd && filteredStocks.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-slate-800 border border-white/10 rounded-xl shadow-lg z-10 max-h-48 overflow-y-auto">
                  {filteredStocks.slice(0, 10).map((stock) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-slate-500">Select to view details</div>
                    </button>
                  ))}
                </div>
              )}
              ...
              {showStockDropdown && !stockToAdd && searchQuery && filteredStocks.length === 0 && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-slate-800 border border-white/10 rounded-xl shadow-lg z-10 p-4 text-center text-slate-400">
              ...
              <div className="mb-6 p-4 bg-indigo-500/10 rounded-xl border border-indigo-500/20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-bold text-white">₹{stockDetails.currentPrice.toFixed(2)}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-500 uppercase tracking-wide">Price Change</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 pt-4 border-t border-white/10">
                  <div className="text-center">
                    ...
                    <p className="font-semibold text-white">₹{stockDetails.open.toFixed(2)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-slate-500 uppercase">High</p>
                    <p className="font-semibold text-white">₹{stockDetails.high.toFixed(2)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-slate-500 uppercase">Low</p>
                    <p className="font-semibold text-white">₹{stockDetails.low.toFixed(2)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-slate-500 uppercase">Close</p>
                    <p className="font-semibold text-white">₹{stockDetails.close.toFixed(2)}</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-white"
                ...
                {/* Investment Summary */}
                {quantity && price && (
                  <div className="md:col-span-2 p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20">
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <p className="text-xs text-slate-500 uppercase font-semibold">Total Investment</p>
                        <p className="text-xl font-bold text-emerald-400">₹{totalInvestment.toFixed(2)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-500 uppercase font-semibold">Per Share</p>
                        <p className="text-lg font-semibold text-slate-300">₹{parseFloat(price).toFixed(2)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-500 uppercase font-semibold">Quantity</p>
                        <p className="text-lg font-semibold text-slate-300">{quantity}</p>
                      </div>
                    </div>
                    ...
                    {futureAveragePrice > 0 && (
                      <div className="mt-4 pt-4 border-t border-emerald-500/20">
                        <p className="text-xs text-emerald-400 font-semibold mb-2">📊 Portfolio Impact</p>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            <span className="text-slate-400">New Average:</span>
                            <p className="font-bold text-indigo-400">₹{futureAveragePrice.toFixed(2)}</p>
                          </div>
                        </div>
                      </div>
                    )}
            ...
            <div className="flex justify-end space-x-3 mt-8">
              <button
                className="px-6 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-semibold transition-colors border border-white/10"
                onClick={() => {
                  setShowAddStockModal(false);
                  setStockToAdd(null);
                  setPurchaseDate("");
              ...
              <button
                className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-500 transition-colors shadow-[0_0_15px_rgba(16,185,129,0.3)] flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-slate-900/90 backdrop-blur-2xl border border-white/10 p-8 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] w-96 max-w-md mx-4">
            <div className="flex items-center justify-center mb-6">
              <div className="p-3 bg-red-500/20 border border-red-500/20 rounded-full">
            ...
            <h2 className="text-2xl font-bold text-white text-center mb-2">Delete Portfolio?</h2>
